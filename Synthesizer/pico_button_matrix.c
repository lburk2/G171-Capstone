...
char pico_keypad_get_key(void) {
    ...
    if (cols == column_mask[0]) {
        return (char)_matrix_values[row * 5 + 0];
    }
    else if (cols == column_mask[1]) {
        return (char)_matrix_values[row * 5 + 1];
    }
    if (cols == column_mask[2]) {
        return (char)_matrix_values[row * 5 + 2];
    }
    else if (cols == column_mask[3]) {
        return (char)_matrix_values[row * 5 + 3];
    }
        if (cols == column_mask[4]) {
        return (char)_matrix_values[row * 5 + 4];
    }
    else {
        return 0;
    }
